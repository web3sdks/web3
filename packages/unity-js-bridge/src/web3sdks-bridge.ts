/// --- Web3sdks Brige ---
import { CoinbasePayIntegration, FundWalletOptions } from "@web3sdks/pay";
import { ChainOrRpc, Web3sdksSDK, getRpcUrl } from "@web3sdks/sdk";
...
import {
  ...
  InjectedWallet,
  MagicAuthWallet,
} from "@web3sdks/wallets";
import type { AbstractWallet } from "@web3sdks/wallets/dist/declarations/src/wallets/base";
...
class Web3sdksBridge implements TWBridge {
  ...
  private activeSDK: Web3sdksSDK | undefined;
  ...
  public initialize(chain: ChainOrRpc, options: string) {
    ...
    this.activeSDK = new Web3sdksSDK(rpcUrl, sdkOptions, storage);
    for (let wallet of WALLETS) {
      const walletInstance = new wallet({
        appName: sdkOptions.wallet?.appName || "web3sdks powered dApp",
