import { Web3sdksNextAuthConfig } from "./types";
...
export function Web3sdksNextAuth(cfg: Web3sdksNextAuthConfig) {
  const sdk = Web3sdksSDK.fromPrivateKey(cfg.privateKey, "mainnet");

  function Web3sdksProvider(res: GetServerSidePropsContext["res"]) {
