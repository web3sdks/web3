...
import type { Pack as PackContract } from "@web3sdks/contracts-js";
import type ABI from "@web3sdks/contracts-js/dist/abis/Pack.json";
import { PackUpdatedEvent } from "@web3sdks/contracts-js/dist/declarations/src/IPack";
import {
  ITokenBundle,
  PackCreatedEvent,
  PackOpenedEvent,
} from "@web3sdks/contracts-js/dist/declarations/src/Pack";
