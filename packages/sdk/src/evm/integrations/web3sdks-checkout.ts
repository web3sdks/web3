...
import { SignatureDrop } from "@web3sdks/contracts-js/dist/declarations/src/SignatureDrop";
...
export const PAPER_API_URL =
  `${PAPER_API_BASE}/${PAPER_API_VERSION}/platform/web3sdks` as const;
