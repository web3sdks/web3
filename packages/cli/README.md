...
<h1 align="center">web3sdks CLI</h1>
<p align="center">
<a href="https://www.npmjs.com/package/@web3sdks/cli"><img src="https://img.shields.io/npm/v/@web3sdks/cli?color=red&logo=npm" alt="npm version"/></a>
...
The web3sdks CLI is your one-stop-shop for publishing custom contracts for your team or the world to use. The CLI uploads all necessary data to decentralized storage and makes it available to deploy via the web3sdks sdk or web3sdks dashboard.

This brings all the capabilities of web3sdks to your own custom contracts.
...
- Upload ABIs to IPFS
- Open the deploy flow in your web3sdks dashboard in a browser

From the web3sdks dashboard, you can review and deploy your contracts on any supported EVM chain.
