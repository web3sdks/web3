...
export async function createContractProject({
  ...
  if (onlyContract) {
    ...
    console.log(
      `Creating a new web3sdks contracts project in ${chalk.green(root)}.`,
    );
    console.log();
    ...
    console.log(
      "    Compiles your contracts and detects web3sdks extensions implemented on them.",
    );
    console.log();
    console.log(
      chalk.cyan(`  ${packageManager}${useYarn ? "" : " run"} deploy`),
    );
    console.log("    Deploys your contracts with the web3sdks deploy flow.");
    console.log();
    console.log(
      chalk.cyan(`  ${packageManager}${useYarn ? "" : " run"} release`),
    );
    console.log("    Releases your contracts with the web3sdks release flow.");
    console.log();
