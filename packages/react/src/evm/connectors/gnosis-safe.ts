...
export function useGnosis() {
  ...
  invariant(
    wagmiContext,
    `useGnosis() can only be used inside <Web3sdksProvider />. If you are using <Web3sdksSDKProvider /> you will have to use your own wallet-connection logic.`,
  );
  ...
  invariant(
    connector,
    "Gnosis connector not found, please make sure it is provided to your <Web3sdksProvider />",
  );
